    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
            ...
            <main className="">
                ...
                <section className='bg-blue-600 flex flex-col items-center justify-center gap-4 py-4 '>
                    ...
                    <button className="bg-white hover:bg-gray-200 py-2 px-3 rounded-lg font-semibold cursor-pointer">
